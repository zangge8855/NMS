...
function formatInboundLine(helpers: any, item: any): string {
...
function collectInboundRows(snapshot: any = {}): any[] {
    const snapshots = Array.isArray(snapshot?.panelSnapshots) ? snapshot.panelSnapshots : [];
    return snapshots.flatMap((panelSnapshot: any) => {
...
export function registerInboundCommands(registry: CommandRegistry, ctx: any): void {
