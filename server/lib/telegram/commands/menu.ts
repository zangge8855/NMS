import { buildMenuKeyboard, type MenuItem } from '../inlineKeyboards.js';
...
export function registerMenuCommands(registry: CommandRegistry, ctx: any): void {
    const { helpers } = ctx;
...
export const MENU_CALLBACK_COMMANDS: Readonly<Record<string, string>> = Object.freeze({
    clients: '/clients',
    servers: '/servers',
    inbounds: '/inbounds',
    audit: '/audit',
