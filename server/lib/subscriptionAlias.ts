const RESERVED_EXACT_PATHS = new Set<string>([
    '/',
    '/login',
    '/favicon.ico',
    '/robots.txt',
...
export function normalizeSubscriptionAliasPath(value: unknown): string {
...
export function isReservedSubscriptionAliasPath(value: unknown): boolean {
...
export interface ValidateSubscriptionAliasOptions {
    findByPath?: (path: string) => any;
    excludeUserId?: string;
}

export interface ValidateSubscriptionAliasResult {
    ok: boolean;
    value: string;
    message?: string;
}

export function validateSubscriptionAliasPath(value: unknown, options: ValidateSubscriptionAliasOptions = {}): ValidateSubscriptionAliasResult {
    const normalized = normalizeSubscriptionAliasPath(value);
    if (!normalized) {
