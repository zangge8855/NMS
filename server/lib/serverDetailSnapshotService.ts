...
function normalizeOnlineEntries(items: any): string[] {
    if (!items) return [];
...
function normalizeLastOnlineMap(input: any = {}): Record<string, number> {
...
function buildStatusMeta(item: any = null) {
...
async function buildServerDetailSnapshot(serverId: string, options: any = {}, deps: any = {}): Promise<any> {
