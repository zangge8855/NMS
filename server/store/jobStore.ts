...
const retryRequestCache = new Map<string, any>();
...
function saveArrayAtomic(file: string, data: any): void {
...
function deriveStatus(summary: any = {}): string {
...
function deriveFailureGroups(results: any[] = [], maxGroups: number = 30): any[] {
...
class JobStore {
    ...
    getUnredactedRequest(id: string): any {
