...
export function buildStoreSnapshotComparison(key: string, filePayload: any, dbPayload: any, options: any = {}): any {
...
const STORE_REGISTRY: StoreRegistryEntry[] = [
...
function resolveKeys(inputKeys: any = []): StoreRegistryEntry[] {
...
export function collectStoreSnapshots(inputKeys: any = []): Record<string, any> {
...
export async function hydrateStoresFromDatabase(inputKeys: any = []): Promise<any> {
    const items = resolveKeys(inputKeys);
    const details: any[] = [];
...
export async function backfillStoresToDatabase(options: any = {}): Promise<any> {
...
export async function verifyStoresAgainstDatabase(options: any = {}): Promise<any> {
...
export async function restoreStoreSnapshots(snapshots: any = {}, options: any = {}): Promise<any> {
    const items = resolveKeys(options.keys);
