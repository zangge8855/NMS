...
function reviewExpiry(daysFromNow) {
    return Date.now() + (Number(daysFromNow || 0) * 24 * 60 * 60 * 1000);
}
...
const TOKEN_FIXTURES = Object.freeze([
    {
        ...
        expiresAt: new Date(reviewExpiry(30)).toISOString(),
