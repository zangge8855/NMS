...
const BLOCKED_BOT_PATTERNS: Array<[string, RegExp]> = [
...
export function getRobotsHeaderValue(): string {
    return ROBOTS_HEADER_VALUE;
}

export function getBlockedBotId(userAgent: unknown = ''): string {
...
export interface SearchBotProtectionOptions {
    forbiddenBody?: string;
    robotsBody?: string;
}

export function createSearchBotProtectionMiddleware(options: SearchBotProtectionOptions = {}) {
