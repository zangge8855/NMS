...
function normalizeClientIdentifier(target: any = {}, fallbackClient: any = {}, protocolHint = '') {
...
function normalizeClientData(input: any = {}, fallbackIdentifier = '', options: any = {}) {
...
function hasRequiredCredential(client: any = {}, protocol = '') {
...
function buildFormBody(data: any = {}) {
...
function assertSuccess(response: any, fallbackMessage = '操作失败') {
...
function normalizeInboundSnapshot(input: any = {}, enableOverride = null) {
...
function buildInboundSyncTargetKey(item: any = {}) {
...
function buildInboundSubscriptionSyncOutput(action: any, syncResult: any = {}, candidates: any[] = []) {
...
function findTargetClientInInbound(inbound: any = {}, target: any = {}, protocolHint = '') {
...
function buildClientAdjustPatch(sourceClient: any = {}, payload: any = {}) {
...
function pushBatchHistory(type, action, output, req, requestSnapshot, extra: any = {}) {
...
async function performInboundBatch({
    ...
    if (action === 'add') {
        ...
        const output: any = summarizeBatchResults(action, results);
...
function buildClientTargetKey(target: any = {}) {
    return [
...
function buildInboundTargetKey(target: any = {}) {
    const inboundId = target.id ?? target.inboundId;
    return [
        toStringValue(target.serverId),
...
function buildRetryRequestSnapshot(entry, options: any = {}) {
...
function inferInboundTargetCount(action, targets: any[] = [], serverIds: any[] = []) {
    if (action === 'add') {
...
function buildHistoryListResponse(req, options: any = {}) {
