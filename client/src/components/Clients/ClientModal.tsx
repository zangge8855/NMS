...
import { generateSecurePassword, generateUuidLocal, generateHexToken } from '../../utils/crypto';
...
function resolveClientIdentifier(client: any = {}, protocol: any = '') {
...
function getTargetKey(target: any = {}) {
