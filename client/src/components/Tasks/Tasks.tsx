...
import ListToolbar, { ListPagination } from '../UI/ListToolbar';
...
export default function Tasks({ embedded = false }) {
    ...
    const fetchTasks = async (options: any = {}) => {
    ...
    const shellClassName = embedded ? 'tasks-embedded-shell' : 'page-content page-content--wide page-enter tasks-page';
