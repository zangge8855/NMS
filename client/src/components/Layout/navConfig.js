...
export const navSections = [
    ...
    },
    {
        ...
        items: [
            ...
            { path: '/capabilities', icon: HiOutlineSignal, label: { 'zh-CN': '3x-ui 能力', 'en-US': '3x-ui Capabilities' }, supportsGlobal: false, keywords: ['能力', '探测', 'capabilities'] },
            { path: '/tools', icon: HiOutlineWrenchScrewdriver, label: { 'zh-CN': '节点工具', 'en-US': 'Node Tools' }, supportsGlobal: false, keywords: ['工具', 'tools'] },
        ],
    },
    {
        title: { 'zh-CN': '系统设置', 'en-US': 'Settings' },
        items: [
            ...
            { path: '/server', icon: HiOutlineCog6Tooth, label: { 'zh-CN': '节点控制台', 'en-US': 'Node Console' }, supportsGlobal: true, keywords: ['节点', '控制台', 'server', 'node'] },
...
export const footerNavItems = [
    { path: '/servers', icon: HiOutlineServerStack, label: { 'zh-CN': '服务器管理', 'en-US': 'Servers' }, supportsGlobal: true, adminOnly: true, section: { 'zh-CN': '系统', 'en-US': 'System' }, keywords: ['服务器', '节点', 'server', 'registry'] },
];
