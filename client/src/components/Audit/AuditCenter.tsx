...
import { formatBytes, formatDateOnly, formatDateTime as formatDateTimeValue, getErrorMessage } from '../../utils/format';
...
import { ListPagination } from '../UI/ListToolbar';
...
function appendDateFilterParams(params: any, filters: any = {}) {
...
function appendAuditEventFilterParams(params: any, filters: any = {}) {
...
function appendAccessFilterParams(params: any, filters: any = {}) {
    appendDateFilterParams(params, filters);
...
function buildAuditEventExportParams(filters: any = {}) {
...
function formatCopyTemplate(template: any, replacements: any = {}) {
...
function resolveTrafficOverviewForWindow(windowKey: any, overview: any = null, windows: any = {}) {
...
function hasDefaultEventFilters(filters: any = {}, page: any = 1) {
    return !filters.q
        && !filters.from
        && !filters.to
        && !filters.eventType
...
function hasVisibleTrafficSnapshot(snapshot: any = {}) {
...
function hasVisibleAccessSnapshot(snapshot: any = {}) {
...
function buildAccessSummaryParams(filters: any = {}, { days = null }: any = {}) {
...
function countActiveFilters(filters: any = {}) {
