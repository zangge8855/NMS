...
export function resolveLocaleTag(locale: string = 'zh-CN'): 'en-US' | 'zh-CN' {
...
function buildFormatterCacheKey(locale: string, options: Intl.DateTimeFormatOptions = {}): string {
 ...
 */
export function formatUptime(seconds: number | string | null | undefined, locale: string = 'zh-CN'): string {
    const normalizedLocale = resolveLocaleTag(locale);
 ...
 */
export function formatDate(dateStr: string | number | Date | null | undefined, locale: string = 'zh-CN'): string {
 ...
 */
export function formatTimestamp(ts: number | string | null | undefined, locale: string = 'zh-CN'): string {
 ...
 */
export function getProtocolColor(protocol?: string | null): string {
 ...
 */
export function getErrorMessage(err: any, fallback: string = '操作失败', locale: string = 'zh-CN'): string {
